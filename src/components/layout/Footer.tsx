      ...
      <div className="container-page">
        <div className="grid gap-10 lg:grid-cols-12">
          <div className="lg:col-span-5">
            <Link href="/" className="inline-flex items-center gap-2" aria-label="Home">
              <span className="grid h-9 w-9 place-items-center rounded-lg border border-av-green-deep/60 bg-av-green/10 text-av-green">
            ...
            <div className="mt-6 flex items-center gap-3">
              <a
                ...
                className="grid h-10 w-10 place-items-center rounded-xl border border-av-line bg-av-surface/60 text-av-muted transition-colors hover:border-av-green-deep/60 hover:text-av-green"
                aria-label="LinkedIn (link esterno)"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                className="grid h-10 w-10 place-items-center rounded-xl border border-av-line bg-av-surface/60 text-av-muted transition-colors hover:border-av-green-deep/60 hover:text-av-green"
                aria-label="Instagram (link esterno)"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                className="grid h-10 w-10 place-items-center rounded-xl border border-av-line bg-av-surface/60 text-av-muted transition-colors hover:border-av-green-deep/60 hover:text-av-green"
                aria-label="YouTube (link esterno)"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                className="grid h-10 w-10 place-items-center rounded-xl border border-av-line bg-av-surface/60 text-av-muted transition-colors hover:border-av-green-deep/60 hover:text-av-green"
                aria-label="X / Twitter (link esterno)"
              >
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="mt-5 space-y-4 text-sm">
              <li>
                ...
                >
                  <Mail className="h-4 w-4 text-av-green" />
              ...
              <li>
                <a
                  ...
                  className="inline-flex items-center gap-3 text-av-muted transition-colors hover:text-white"
                >
                  <span className="grid h-4 w-4 place-items-center text-av-green">
        ...
        <div className="mt-14 border-t border-av-line pt-8">
          ...
          <div className="mt-8 flex flex-col items-start justify-between gap-4 text-xs text-av-muted sm:flex-row sm:items-center">
            ...
            <p className="max-w-md text-right">{siteConfig.legal.address}</p>
          </div>
        </div>
      </div>
    </footer>
