...
export default function TradingStarterCheckoutButton({
  label = 'buy',
  compact = false,
  className = '',
}: Props) {
  ...
  const ctaLabel = label === 'resume' ? 'RIPRENDI PAGAMENTO' : 'Scarica la guida · 9,90 €';
        ...
        ? createPortal(
            ...
            >
              ...
              <div
                role="dialog"
                aria-modal="true"
                aria-labelledby="trading-starter-consent-title"
                aria-describedby="trading-starter-consent-desc"
              ...
              >
                ...
                <p
                  id="trading-starter-consent-desc"
                ...
                <div className="mt-5 space-y-3">
                  <label
                    htmlFor="trading-starter-consent-terms"
                  ...
                  >
                    <input
                      id="trading-starter-consent-terms"
                      type="checkbox"
                      checked={acceptTerms}
                  ...
                  <label
                    htmlFor="trading-starter-consent-digital"
                    className={`flex cursor-pointer items-start gap-3 rounded-xl border p-4 transition ${
                      acceptDigital
                        ? 'border-av-green-deep/60 bg-av-green/10'
                        : 'border-av-line bg-av-bg-2/50 hover:border-white/15'
                  ...
                  >
                    <input
                      id="trading-starter-consent-digital"
                      type="checkbox"
